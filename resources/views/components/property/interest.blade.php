    ...
    <div class="container">
        <div class="row mb64 mb-xs-24">
            <div class="col-sm-12 text-center">
                <h2 class="uppercase color-primary">Register Interest</h2>
                <p class="lead">
                    We'll update you via e-mail with property inspection times
                </p>
            </div>
        </div>
        <!--end of row-->
        ...
        <div class="row">
            <div class="col-sm-12 text-center">
                <p class="fade-half">* We won't share your email with any third parties.</p>
            </div>
        </div>
        <!--end of row-->
    </div>
